...
# Go to http://twitter.com/aps/new to create and app and get these items
import twitter_consumer

consumer_key = twitter_consumer.get_consumer_key()
consumer_secret = twitter_consumer.get_consumer_secret()

SCREEN_NAME = sys.argv[1]
friends_limit = 10000

#2345678901234567890123456789012345678901234567890123456789012345678901234567890
(oauth_token, oauth_token_secret) = oauth_dance('funwalla', 
                                                consumer_key, 
                                                consumer_secret)
